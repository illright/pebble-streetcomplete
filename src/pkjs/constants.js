...
var OSM_AUTH_BASE_URL = overrides.OSM_AUTH_BASE_URL || config.OSM_AUTH_BASE_URL;
var CLIENT_ID = overrides.CLIENT_ID || config.CLIENT_ID;
...
module.exports = {
  ...
  OSM_AUTH_BASE_URL: OSM_AUTH_BASE_URL,
  CLIENT_ID: CLIENT_ID,
